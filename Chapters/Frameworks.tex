...
\begin{enumerate}
    ...
    \item Improving the tooling around training - building clever software frameworks, that will 
        ...
        %a convenient interface in high-level language (Python, Lua, TF, Torch, PyTorch),
...
% TODO: Add information about cuDNN \cite{chetlur2014cudnn} and TensorFlow XLA compiler \cite{abadi2017computational}.
